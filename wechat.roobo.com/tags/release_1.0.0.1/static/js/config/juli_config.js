 ...
 */
 ...
 if (DEBUG){
   window.juli.host = "http://172.17.232.3";           //开发环境接口地址
   window.juli.root="http://dwn.roo.bo/appimg/";                 //rooboAI系统测试地址
   window.juli.search="http://172.17.132.97:8090";                 //搜索接口
 }
 else{
...
juli.URL = {
    ...
    download :window.juli.host + "/storybox/track/download.do",           //媒体下载
    ...
    //点播历史相关
    play:      window.juli.host + "/storybox/demand/save.do",              //点播
    ...
    getlist:    window.juli.host + "/storybox/track/getlist.do",                   //获取设备二维码信息
    remove:     window.juli.host + "/storybox/track/remove.do",                   //获取设备二维码信息
    singleview: window.juli.host + "/storybox/track/getid.do"                   //获取设备二维码信息
  };
